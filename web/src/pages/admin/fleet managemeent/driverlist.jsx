...
export default function DriverFleetDirectory() {
  // State: Modal Open/Close Controller
...
/* ---------------- Modified Styled Framework Layout Core ---------------- */
...
const RegistryGridTable = styled.table`
    ...
    thead tr { 
        border-bottom: 1px solid #e2e8f0; /* 👈 हेडर बॉर्डर को सॉफ्ट ग्रे किया */
    ...
    /* 🔴 फ़ीके व्हाइट टेक्स्ट को डार्क स्लेट ब्लैक बनाने के लिए ग्लोबल रूल्स */
    .text-dark { color: #0f172a !important; }
    .text-muted { color: #475569 !important; }
    .font-bold { font-weight: 600; color: #0f172a !important; }
    .font-semibold { font-weight: 600; color: #1e293b !important; }
