                  ...
                  {driversData.length === 0 ? (
                    <tr>
                      <td colSpan="7" style={{ textAlign: 'center', color: '#94a3b8', padding: '24px' }}>
                        डेटाबेस में कोई ड्राइवर रिकॉर्ड नहीं मिला। नया driver जोड़ने के लिए "+ Add Driver" पर क्लिक करें।
                      </td>
                    </tr>
                  ) : (
                    driversData.map((driver, index) => (
                      <tr key={driver.id || index}>
                        {/* 🔴 FIXED: यहाँ क्रम को हमेशा लाइव रखने के लिए गणितीय इंडेक्स स्ट्रक्चर सेट किया गया है */}
                        <td className="font-mono text-muted">#{driversData.length - index}</td>
                        <td>
                          <DriverProfileBox>
